...
class ToolChain( base.ToolChain ):
    ...
    def __init__( self, exename, prjdir, build_variants, default_variant='release' ):
        ...
        #
        self._base_release.cflags    = '/nologo  /D "_CRT_SECURE_NO_WARNINGS" /D "_CONSOLE" /D "_MBCS" /Gm /Zi /FD /D "WIN32" /D "WIN32_LEAN_AND_MEAN" /c /D "BUILD_TIME_UTC={:d}"'.format(self._build_time_utc)
        ...
        self._debug_release.cflags    = '/Zi /Od /D "_DEBUG" /RTCs'
